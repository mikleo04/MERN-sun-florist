...
const CreateFlower = () => {
    ...
    return (
        <div className='p-4 flex justify-center'>
            <button type="button"
                    className=" absolute start-0 top-0 mt-5 ms-5 gap-2 text-white bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <IconChevronsLeft/>
                Back
            </button>
            {loading ? <Spin/> : ''}
